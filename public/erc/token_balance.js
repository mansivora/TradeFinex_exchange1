...
var coinAddress=process.argv[5];
var tokendecimal=process.argv[6];
...
var bal = coin.balanceOf(address);
if(tokendecimal == 18 || tokendecimal == null) {
    bal = web3.fromWei(bal, "ether").toString(10);
}
else
{
    bal = (bal.toNumber()/Math.pow(10,tokendecimal)).toString(10);
}
console.log(bal);
