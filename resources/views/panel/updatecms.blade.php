                    ...
                    <div class="col-md-12">
                        ...
                        <div id="generalTabContent" class="tab-content">
                            <div id="tab-edit" class="tab-pane fade in active">
                                <form action="{{url('check_admin/updatecms/'.$id)}}" method="post"
                                    ...
                                    <div class="form-group"><label class="col-sm-3 control-label">Page </label>
                                        ...
                                        <div class="col-sm-9 controls">
                                            <div class="row">
                                                <div class="col-xs-9"><input type="text" value="{{$result->link}}"
                                    ...
                                    <div class="form-group"><label class="col-sm-3 control-label">Heading </label>
                                        ...
                                        <div class="col-sm-9 controls">
                                            <div class="row">
                                                <div class="col-xs-9"><input type="text" name="heading"
                                            ...
                                            <div class="row">
                                                <div class="col-xs-9">
                                                    <textarea class="form-control" name="content"
                                                              id="content">{{$result->content}}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
