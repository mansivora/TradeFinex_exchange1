                                ...
                                <div class="row">
                                    <form id="form_filters" method="get">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <a href="{{url('/check_admin/export_user_list')}}" class="btn btn-default"
                                               style="margin-top: 17px;"><i class="fa fa-download">CSV</i></a>
                                        </div>
                                        ...
                                        @if($result)
                                            @foreach($result as $val)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{url('check_admin/status_users/'.$val->id)}}"
                                                           title="active/deactive account"><i class="fa fa-cog"></i></a>
                                                        <a href="{{url('check_admin/view_users/'.$val->id)}}"
