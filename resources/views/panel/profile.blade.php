                    ...
                    <div class="col-md-12">
                        ...
                        <div id="generalTabContent" class="tab-content">
                            <div id="tab-edit" class="tab-pane fade in active">
                                <form action="{{url('check_admin/profile')}}" method="post" class="form-horizontal">
                                        ...
                                        <div class="col-sm-9 controls">
                                            <div class="row">
                                                <div class="col-xs-9"><input type="email"
                                                                             ...
                                                                             value="{{get_adminprofile('email_id')}}"/>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group"><label class="col-sm-3 control-label">Username *</label>
                                        ...
                                        <div class="col-sm-9 controls">
                                            <div class="row">
                                                <div class="col-xs-9"><input type="text" placeholder="username"
                                                                             name="admin_username"
                                                                             value="{{get_adminprofile('EX_username')}}"
                                    ...
                                    <div class="form-group"><label class="col-sm-3 control-label">Phone</label>
                                        ...
                                        <div class="col-sm-9 controls">
                                            <div class="row">
                                                <div class="col-xs-9"><input type="text" placeholder="9876543210"
                                                                             name=""
                                                                             value="{{owndecrypt(get_adminprofile('phone'))}}"
                                    ...
                                    <div class="form-group"><label class="col-sm-3 control-label">Country</label>
                                        ...
                                        <div class="col-sm-9 controls">
                                            <div class="row">
                                                <div class="col-xs-9"><input type="text" placeholder="India"
                                                                             name="admin_country"
                                                                             value="{{get_adminprofile('country')}}"
                                                                             class="form-control"/></div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group"><label class="col-sm-3 control-label">Current
                                            Password</label>
                                        ...
                                        <div class="col-sm-9 controls">
                                            <div class="row">
                                                <div class="col-xs-4"><input type="password"
                                                                             ...
                                                                             name="curr_pass" class="form-control"/>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group"><label class="col-sm-3 control-label">New Password</label>
                                        ...
                                        <div class="col-sm-9 controls">
                                            <div class="row">
                                                <div class="col-xs-4"><input type="password" placeholder="New Password"
                                    ...
                                    <div class="form-group"><label class="col-sm-3 control-label">Confirm New
                                            Password</label>
