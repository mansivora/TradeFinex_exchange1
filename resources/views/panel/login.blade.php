...
<body id="signin-page">
<div class="page-form">
    <form action="{{url('/check_admin')}}" class="form" method="post">
        ...
        <div class="body-content">
            ...
            <hr>
            <p>Forgotten your Password? <a id="btn-register" href="{{url('check_admin/forgot')}}">Forgot Now</a></p>
        </div>
    </form>
</div>
...
<script>
    ...
    function word() {
        ...
        $.ajax({
            type: 'post',
            url: '{{url("check_admin/checkpattern")}}',
